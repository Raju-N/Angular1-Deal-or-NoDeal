app.controller('gameController',['$scope','$location','gameService','$timeout',function($scope,$location,gameService,$timeout) {
...
function initial(){
	...
	/*once game finished,on pressing back or changing in url it redirects to home*/
...
//function control once the box is clicked
$scope.eliminateBox=function(a){
	if(a.openCaseClass=="" && animated==false)
	{
		...
		a.number='';
		$timeout(function(){
			a.openINR='assets/images/inr2.png';
